...
Usage:
    python extensions/optimize_crypto.py --synthetic --sweep position_size_pct
    python extensions/optimize_crypto.py --synthetic --sweep min_score
    python extensions/optimize_crypto.py --synthetic --grid quick
"""
...
from extensions.run_crypto_backtest import (
    CACHE_DIR,
    _apply_proxy_env,
    _synthetic_ohlcv,
    build_config,
